...
extension UIViewController {
    ...
    open func addKeyboardWillShowNotification() {
        self.addNotificationObserver(UIViewController.keyboardWillShowNotification.rawValue, selector: #selector(UIViewController.keyboardWillShowNotification(_:)))
    }
    ...
    public func addKeyboardDidShowNotification() {
        self.addNotificationObserver(UIViewController.keyboardDidShowNotification.rawValue, selector: #selector(UIViewController.keyboardDidShowNotification(_:)))
    }
    ...
    open func addKeyboardWillHideNotification() {
        self.addNotificationObserver(UIViewController.keyboardWillHideNotification.rawValue, selector: #selector(UIViewController.keyboardWillHideNotification(_:)))
    }
    ...
    open func addKeyboardDidHideNotification() {
        self.addNotificationObserver(UIViewController.keyboardDidHideNotification.rawValue, selector: #selector(UIViewController.keyboardDidHideNotification(_:)))
    }
    
    ///EZSE: Removes keyboardWillShowNotification()'s NotificationCenter Observer
    open func removeKeyboardWillShowNotification() {
        self.removeNotificationObserver( UIViewController.keyboardWillShowNotification.rawValue)
    }
    
    ///EZSE: Removes keyboardDidShowNotification()'s NotificationCenter Observer
    open func removeKeyboardDidShowNotification() {
        self.removeNotificationObserver(UIViewController.keyboardDidShowNotification.rawValue)
    }
    
    ///EZSE: Removes keyboardWillHideNotification()'s NotificationCenter Observer
    open func removeKeyboardWillHideNotification() {
        self.removeNotificationObserver(UIViewController.keyboardWillHideNotification.rawValue)
    }
    
    ///EZSE: Removes keyboardDidHideNotification()'s NotificationCenter Observer
    open func removeKeyboardDidHideNotification() {
        self.removeNotificationObserver(UIViewController.keyboardDidHideNotification.rawValue)
    }
...
//        let tvc = self.tabBarController as! DepthTabbarController
//        tvc.hideTabbarView()
    }
