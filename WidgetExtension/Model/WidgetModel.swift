...
//MARK: - 子视图 模型
/// 子视图 父类
class SuperSingleViewModel: HandyJSON, Hashable, Identifiable, ObservableObject {
    ...
    var contentAtt: [String: Any]?                      //内容类型所需要相关配置（待用，例如电量图片变化节点等）
    
    required init() {

    }
    init(viewType: WidgetViewTypeEnum? = nil, sharedContent: SharedAttModel? = nil, contentType: WidgetContentTypeEnum? = nil, contentAtt: [String: Any]?) {
